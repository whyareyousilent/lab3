let books = [
    ...
    },
    {
      ...
      image: "media\\3.jpg",
      description:
        "Симпатичний та атмосферний детективний трилер, знятий за мотивами однойменного роману Жан-Крістофа Гранже. В центрі сюжету історія вже немолодого детектива поліції П'єра Німана. Він добіса добрий детектив, один з кращих. Розумний і хоробрий, за словом в кишеню не полізе. ЦІНА:420",
      category: "детективи",
    },
    {
      id: 4,
      ...
      image: "media\\4.jpg",
      description:
        "У пошуках серійного вбивці, який знімає шкіру зі своїх жертв, ФБР звертається за допомогою до відомого злочинця – Ганнібала Лектера, що перебуває в ізоляторі психлікарні. Він погоджується взяти участь у пошуках убивці, але за однієї умови – він хоче грати. Два маніяки, дві сповіді. ЦІНА:350",
      category: "детективи",
    },
    {
      id: 5,
      ...
      image: "media\\5.jpg",
      description:
        "роман американського письменника Стівена Кінга, написаний у жанрі жахів, уперше опублікований 1986 року видавництвом Viking Press. У творі зачіпаються важливі для Кінга теми: влада пам'яті, сила в об'єднанні, вплив травм дитинства на доросле життя. ЦІНА:350",
      category: "жахи",
    },
    {
      id: 6,
    ...
    },
    {
      ...
      image: "media\\8.jpg",
      description:
        "«Дім дивних дітей» — химерна маленька книжка з чорно-білими світлинами. Книга про подорож у часі, дітей, здатних на чарівні речі, та про жахливих чудовиськ. <...> А справжнім завданням першої частини — створення будови цього світу, введення концепції світу з безліччю часових контурів та дивних дітей. ЦІНА:400",
      category: "фантастика",
    },
    {
      id: 9,
